...
mixin _$NoteEntity {
 ...
 String get id; String get sig; String get authorPubkey; String get content; NoteType get type; List<String> get eTagRefs; List<String> get pTagRefs; List<String> get tTags; int get cachedReactionCount; DateTime get created; bool get isSeen;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NoteEntity&&(identical(other.id, id) || other.id == id)&&(identical(other.sig, sig) || other.sig == sig)&&(identical(other.authorPubkey, authorPubkey) || other.authorPubkey == authorPubkey)&&(identical(other.content, content) || other.content == content)&&(identical(other.type, type) || other.type == type)&&const DeepCollectionEquality().equals(other.eTagRefs, eTagRefs)&&const DeepCollectionEquality().equals(other.pTagRefs, pTagRefs)&&const DeepCollectionEquality().equals(other.tTags, tTags)&&(identical(other.cachedReactionCount, cachedReactionCount) || other.cachedReactionCount == cachedReactionCount)&&(identical(other.created, created) || other.created == created)&&(identical(other.isSeen, isSeen) || other.isSeen == isSeen));
}


@override
int get hashCode => Object.hash(runtimeType,id,sig,authorPubkey,content,type,const DeepCollectionEquality().hash(eTagRefs),const DeepCollectionEquality().hash(pTagRefs),const DeepCollectionEquality().hash(tTags),cachedReactionCount,created,isSeen);

@override
String toString() {
  return 'NoteEntity(id: $id, sig: $sig, authorPubkey: $authorPubkey, content: $content, type: $type, eTagRefs: $eTagRefs, pTagRefs: $pTagRefs, tTags: $tTags, cachedReactionCount: $cachedReactionCount, created: $created, isSeen: $isSeen)';
}
...
@useResult
$Res call({
 String id, String sig, String authorPubkey, String content, NoteType type, List<String> eTagRefs, List<String> pTagRefs, List<String> tTags, int cachedReactionCount, DateTime created, bool isSeen
});
...
/// Create a copy of NoteEntity
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? sig = null,Object? authorPubkey = null,Object? content = null,Object? type = null,Object? eTagRefs = null,Object? pTagRefs = null,Object? tTags = null,Object? cachedReactionCount = null,Object? created = null,Object? isSeen = null,}) {
...
as List<String>,cachedReactionCount: null == cachedReactionCount ? _self.cachedReactionCount : cachedReactionCount // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String sig,  String authorPubkey,  String content,  NoteType type,  List<String> eTagRefs,  List<String> pTagRefs,  List<String> tTags,  int cachedReactionCount,  DateTime created,  bool isSeen)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _NoteEntity() when $default != null:
return $default(_that.id,_that.sig,_that.authorPubkey,_that.content,_that.type,_that.eTagRefs,_that.pTagRefs,_that.tTags,_that.cachedReactionCount,_that.created,_that.isSeen);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String sig,  String authorPubkey,  String content,  NoteType type,  List<String> eTagRefs,  List<String> pTagRefs,  List<String> tTags,  int cachedReactionCount,  DateTime created,  bool isSeen)  $default,) {final _that = this;
switch (_that) {
case _NoteEntity():
return $default(_that.id,_that.sig,_that.authorPubkey,_that.content,_that.type,_that.eTagRefs,_that.pTagRefs,_that.tTags,_that.cachedReactionCount,_that.created,_that.isSeen);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String sig,  String authorPubkey,  String content,  NoteType type,  List<String> eTagRefs,  List<String> pTagRefs,  List<String> tTags,  int cachedReactionCount,  DateTime created,  bool isSeen)?  $default,) {final _that = this;
switch (_that) {
case _NoteEntity() when $default != null:
return $default(_that.id,_that.sig,_that.authorPubkey,_that.content,_that.type,_that.eTagRefs,_that.pTagRefs,_that.tTags,_that.cachedReactionCount,_that.created,_that.isSeen);case _:
  return null;
...
@override final  int cachedReactionCount;
...
@override
int get hashCode => Object.hash(runtimeType,id,sig,authorPubkey,content,type,const DeepCollectionEquality().hash(_eTagRefs),const DeepCollectionEquality().hash(_pTagRefs),const DeepCollectionEquality().hash(_tTags),cachedReactionCount,created,isSeen);
...
/// Create a copy of NoteEntity
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? sig = null,Object? authorPubkey = null,Object? content = null,Object? type = null,Object? eTagRefs = null,Object? pTagRefs = null,Object? tTags = null,Object? cachedReactionCount = null,Object? created = null,Object? isSeen = null,}) {
